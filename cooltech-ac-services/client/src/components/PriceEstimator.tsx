...
export function PriceEstimator() {
  ...
  const selectClass =
    "w-full bg-white border border-border rounded-lg px-3 py-2.5 text-sm text-foreground appearance-none focus:outline-none focus:ring-2 focus:ring-primary/40 cursor-pointer";
  ...
  return (
    <div className="bg-white border border-border rounded-2xl p-6 shadow-sm">
      ...
      <button
        ...
        className="w-full gradient-brand disabled:opacity-40 disabled:cursor-not-allowed text-white font-semibold text-sm py-2.5 rounded-lg transition-all duration-200 active:scale-95"
      >
        Calculate Estimate
      </button>
      {estimate && (
        <div className="mt-4 p-4 bg-primary/10 border border-primary/20 rounded-xl text-center">
          ...
          <Link href="/book">
            <a className="inline-flex items-center gap-1.5 gradient-brand text-white text-sm font-semibold px-4 py-2 rounded-lg hover:opacity-90 transition-opacity">
