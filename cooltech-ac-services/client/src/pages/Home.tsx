    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 gradient-hero text-white">
        <div className="container text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-white/60 text-sm"><Phone className="w-4 h-4" /><a href="tel:+919904089393" className="hover:text-white/80 transition-colors">Call us: +91 9904089393</a></div>
        </div>
      </section>
