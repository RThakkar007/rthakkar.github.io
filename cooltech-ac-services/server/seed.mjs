...
const techniciansData = [
  {
    ...
    longitude: 72.1266,
    city: "Patan, Gujarat",
    bio: "Certified AC technician with 8 years of experience in Patan. Specialized in split AC systems and inverter technology.",
    completedJobs: 3420,
  },
  {
    name: "Suresh Patel",
    ...
    longitude: 72.1350,
    city: "Patan, Gujarat",
    bio: "Expert in AC installation and uninstallation. Handled 500+ installations across Patan and North Gujarat.",
    completedJobs: 2180,
  },
  {
    name: "Amit Singh",
    ...
    longitude: 72.1180,
    city: "Patan, Gujarat",
    bio: "Foam-jet cleaning specialist in Patan. Known for thorough cleaning and attention to detail.",
    completedJobs: 2890,
  },
  {
    name: "Vikram Sharma",
    ...
    longitude: 72.1100,
    city: "Patan, Gujarat",
    bio: "Gas refill and diagnostics expert in Patan. Certified in refrigerant handling and leak detection.",
    completedJobs: 1560,
  },
  {
    name: "Pradeep Yadav",
    ...
    longitude: 72.1400,
    city: "Patan, Gujarat",
    bio: "Senior technician with 10 years of experience in Patan & North Gujarat. Expert in all AC brands including Daikin, Voltas, LG, and Samsung.",
    completedJobs: 4750,
  },
];
