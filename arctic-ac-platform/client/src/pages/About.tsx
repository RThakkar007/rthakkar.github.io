    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="pt-24 pb-20">
        <div className="container max-w-4xl mx-auto">
          <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">{t.about_title}</Badge>
          <h1 className="text-3xl sm:text-5xl font-bold mb-4 sm:mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            {t.about_title} — <span className="gradient-text">ArcticAC</span>
          </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 mb-10 sm:mb-16">
            {[
              { icon: Users, value: "500+", label: t.about_stat1 },
              { icon: Award, value: "50+", label: t.about_stat2 },
              { icon: Clock, value: "< 2hr", label: t.about_stat4 },
              { icon: Shield, value: "100%", label: t.about_stat3 },
            ].map((stat, i) => (
          ...
          <div className="prose prose-invert max-w-none">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{t.about_mission_title}</h2>
