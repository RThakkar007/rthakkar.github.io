...
export function FloatingBookNow() {
  ...
  return (
    ...
    >
      <Link href="/book">
        <a className="flex items-center gap-2 bg-primary hover:bg-primary/90 active:scale-95 text-primary-foreground font-semibold text-sm px-5 py-3 rounded-full shadow-xl shadow-primary/30 transition-all duration-200">
